...
/****** Object:  StoredProcedure [dbo].[IndexOptimize]    Script Date: 8/7/2014 4:52:34 PM ******/
...
@ExcludeIndexFromDefrag bit =1 -- ignore objects
AS
  ...
  BEGIN
    ...
    BEGIN
      ...
      BEGIN
        ...
        IF(Isnull(@ExcludeIndexFromDefrag,1)=1)
        BEGIN
			SET @Error = @@ERROR        
			DELETE from @tmpIndexesStatistics WHERE
			objectID  in (SELECT Object_id FROM dbo.IndexDefragObjectsToExclude)
		END	
