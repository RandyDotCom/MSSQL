...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[instance_files_log]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[instance_files_log](
 ...
 CONSTRAINT [PK_instance_files_log] PRIMARY KEY CLUSTERED 
(
	[idRow] ASC
